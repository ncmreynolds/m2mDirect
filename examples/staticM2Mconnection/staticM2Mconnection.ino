/*
 * This sketch connects two devices with pre-configured MAC addresses, global and local encryption keys
 * 
...
void setup()
{
  ...
  #ifdef LED_BUILTIN
  m2m.indicatorGpio(LED_BUILTIN,true);  //Enable the indicator LED
  #endif
